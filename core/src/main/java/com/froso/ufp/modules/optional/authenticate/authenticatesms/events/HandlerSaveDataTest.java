package com.froso.ufp.modules.optional.authenticate.authenticatesms.events;
 ...
 */
@Component
public class HandlerSaveDataTest implements ApplicationListener<DataDocumentSaveEvent<SMSAuthenticateModel>> {
     ...
     */
    public void onApplicationEvent(DataDocumentSaveEvent<SMSAuthenticateModel> event) {
