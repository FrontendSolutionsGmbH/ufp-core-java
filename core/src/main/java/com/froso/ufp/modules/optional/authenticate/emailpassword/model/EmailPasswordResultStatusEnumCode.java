 ...
 */
public enum EmailPasswordResultStatusEnumCode implements IResultStatusEnumCode {
    /*
     ...
     */
    private static final Map<Integer, EmailPasswordResultStatusEnumCode> LOOKUP = new HashMap<>();
     ...
     */
    static {
        for (EmailPasswordResultStatusEnumCode s : EnumSet.allOf(EmailPasswordResultStatusEnumCode.class)) {
    ...
    EmailPasswordResultStatusEnumCode(int code) {
...
/*
     ...
     */
    public static EmailPasswordResultStatusEnumCode get(int code) {
