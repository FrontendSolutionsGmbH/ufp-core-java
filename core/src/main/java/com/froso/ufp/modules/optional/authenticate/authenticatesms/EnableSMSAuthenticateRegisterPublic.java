...
@Documented
@Import({SMSAuthenticateModuleConfigurationPublic.class, SMSAuthenticateModuleConfigurationRegisterPublic.class})
public @interface EnableSMSAuthenticateRegisterPublic {
}
