...
@Controller
@RequestMapping("/" + BaseRepositoryController.ENDPOINT + "/" + PollDataConfig.TYPE_NAME)
@Api(description = BaseRepositoryController.CRUD_ADMIN_REPOSITORY,
        tags = PollDataConfig.TYPE_NAME)
class AdminDataPollConfigController extends BaseRepositoryController<PollDataConfig> {
