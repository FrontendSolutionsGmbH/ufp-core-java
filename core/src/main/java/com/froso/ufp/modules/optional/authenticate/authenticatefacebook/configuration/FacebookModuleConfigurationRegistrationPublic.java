...
@ComponentScan(includeFilters = {@ComponentScan.Filter(
        ...
        classes = {FacebookRegisterController.class})},
        basePackages = {
...
public class FacebookModuleConfigurationRegistrationPublic {
    ...
    public void configureFacebookModuleConfigurationRegistrationPublic(GlobalsService globalsService) {
     ...
     */
    @Autowired(required = false)
    public void configureFacebookModuleConfigurationRegistrationPublic(RequestDefinitionService requestDefinitionService) {
