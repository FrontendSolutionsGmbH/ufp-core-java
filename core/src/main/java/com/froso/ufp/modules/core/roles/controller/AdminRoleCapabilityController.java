 ...
 */
@Controller
@RequestMapping("/" + BaseRepositoryController.ENDPOINT + "/" + RoleCapability.TYPE_NAME)
@Api(description = BaseRepositoryController.CRUD_ADMIN_REPOSITORY,
        tags = RoleCapability.TYPE_NAME)
class AdminRoleCapabilityController extends BaseRepositoryController<RoleCapability> {
