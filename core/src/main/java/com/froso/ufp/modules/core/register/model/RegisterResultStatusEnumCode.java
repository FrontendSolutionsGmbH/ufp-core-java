...
public enum RegisterResultStatusEnumCode implements IResultStatusEnumCode {
    /*
     ...
     */
    private static final Map<Integer, RegisterResultStatusEnumCode> LOOKUP = new HashMap<>();
     ...
     */
    static {
        for (RegisterResultStatusEnumCode s : EnumSet.allOf(RegisterResultStatusEnumCode.class)) {
    ...
    RegisterResultStatusEnumCode(int code) {
...
/*
     ...
     */
    public static RegisterResultStatusEnumCode get(int code) {
