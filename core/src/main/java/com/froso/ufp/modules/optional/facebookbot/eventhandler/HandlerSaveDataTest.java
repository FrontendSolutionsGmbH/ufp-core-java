package com.froso.ufp.modules.optional.facebookbot.eventhandler;
 ...
 */
@Component
public class HandlerSaveDataTest implements ApplicationListener<DataDocumentSaveEvent<ReceivedFacebookBotMessage>> {
     ...
     */
    public void onApplicationEvent(DataDocumentSaveEvent<ReceivedFacebookBotMessage> event) {
