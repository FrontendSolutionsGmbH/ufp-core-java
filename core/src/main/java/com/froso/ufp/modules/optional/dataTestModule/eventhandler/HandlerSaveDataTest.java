package com.froso.ufp.modules.optional.dataTestModule.eventhandler;
 ...
 */
@Component
public class HandlerSaveDataTest implements ApplicationListener<DataDocumentSaveEvent<DataTestModel>> {
     ...
     */
    public void onApplicationEvent(DataDocumentSaveEvent<DataTestModel> event) {
