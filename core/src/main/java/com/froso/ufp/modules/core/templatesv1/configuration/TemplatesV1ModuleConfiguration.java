...
@ComponentScan(basePackages = {
        "com.froso.ufp.modules.core.templatesv1.service",
        "com.froso.ufp.modules.core.templatesv1.controller.admin"
})
public class TemplatesV1ModuleConfiguration {
    private static final Logger LOGGER = LoggerFactory.getLogger(TemplatesV1ModuleConfiguration.class);
