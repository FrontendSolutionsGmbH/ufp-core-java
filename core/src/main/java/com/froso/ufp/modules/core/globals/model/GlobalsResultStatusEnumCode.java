package com.froso.ufp.modules.core.globals.model;
...
public enum GlobalsResultStatusEnumCode implements IResultStatusEnumCode {
    /*
     ...
     */
    private static final Map<Integer, GlobalsResultStatusEnumCode> LOOKUP = new HashMap<>();
     ...
     */
    static {
        for (GlobalsResultStatusEnumCode s : EnumSet.allOf(GlobalsResultStatusEnumCode.class)) {
    ...
    GlobalsResultStatusEnumCode(int code) {
...
/*
     ...
     */
    public static GlobalsResultStatusEnumCode get(int code) {
