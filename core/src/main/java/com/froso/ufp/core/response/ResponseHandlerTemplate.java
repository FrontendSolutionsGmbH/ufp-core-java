 ...
 */
public final class ResponseHandlerTemplate<T extends IDataObject> {
    ...
    private BackendResponseTemplate<T> response;
     ...
     */
    public ResponseHandlerTemplate() {
     ...
     */
    public ResponseHandlerTemplate(HttpServletRequest request) {
    ...
    private void init() {
        ...
        response = new BackendResponseTemplate<>();
     ...
     */
    public ResponseEntity<BackendResponseTemplate<T>> getResponseEntity() {
     ...
     * @return the response entity
     */
    public ResponseEntity<BackendResponseTemplate<T>> getResponseEntity(HttpStatus status) {
     ...
     * @return
     */
    private BackendResponseTemplate<T> getResponse() {
     ...
     */
    public void addResult(IDataObjectList<T> listInput) {
