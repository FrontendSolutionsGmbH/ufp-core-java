 ...
 */
public class DataDocumentDeleteEvent<DATADOCUMENT extends IDataDocument> extends DataDocumentEvent<DATADOCUMENT> {
     ...
     */
    public DataDocumentDeleteEvent(DATADOCUMENT documentIn, Object source) {
        super(DataDocumentCRUDEvent.DELETE, documentIn, source);
    }
